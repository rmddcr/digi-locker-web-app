        ...
        <div class="form-horizontal">
            <form enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>Employee/edit/<?php echo $employee->epf_no?>">
                ...
                <div class="form-group row">
                    ...
                    <input class="form-control input-default col-sm-10" placeholder="<?php echo $employee->epf_no;?>" value="<?php echo $employee->epf_no;?>"  name="epf_no" type="number" required disabled>
                </div>
                <div class="form-group row">
                    <label class="control-label text-right col-sm-2">Employee Name</label>
                    <input class="form-control input-default col-sm-10" placeholder="<?php echo $employee->name;?>" value="<?php echo $employee->name;?>"  name="name" type="text" required>
                </div>
                ...
                <div class="text-center">
                    <button type="submit" name="new_employee" class="btn btn-warning waves-effect waves-light col-sm-4">Update Employee</button>
                </div>
            </form>
        </div>
    </div>
