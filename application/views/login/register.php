...
span.password-link{
  ...
  <div class="background2"></div>
    ...
    <form>
      <div class="group">
        <input type="name" class="used"><span class="highlight"></span><span class="bar"></span>
        <label>Name</label>
      </div>
      <div class="group">
      ...
      <div class="group">
        <input type="username"><span class="highlight"></span><span class="bar"></span>
      ...
      <div class="group">
        ...
        <a href="login.php">
          <span class="password-link">Want to Sign In?</span>
        </a>
      </div>
      <div>

      </div>
      <button type="button" class="buttonui "> <span> Sign Up </span>
